...
/** Decode browser recording (WebM/MP4) and export WAV bytes for the API. */
export async function blobToWavArrayBuffer(blob: Blob): Promise<ArrayBuffer> {
...
export function sniffAudioFormat(bytes: Uint8Array): 'wav' | 'webm' | 'mp4' | 'unknown' {
